...
This page is a Summer 2026 draft. The Spring project structure is preserved, but dates and Gradescope links should be confirmed before publication.

### PDF Links 

[Data Skills Demonstration Project Part I]({{ site.baseurl }}/src/dp/part1-instructions_sp26.pdf)  

- Group Confirmation Form on Gradescope (TBD).
- Note: Make sure to check in with your assigned GSI before the due date!
- You can find the rubric for Part 1 of the Data Project on Gradescope (TBD).

[Data Skills Demonstration Project Part II]({{ site.baseurl }}/src/dp/part2-instructions_sp26.pdf) 

- Note: Make sure to check in with your assigned GSI before the due date!
- You can find the rubric for Part 2 of the Data Project on Gradescope (TBD).

[Data Skills Demonstration Project Part III]({{ site.baseurl }}/src/dp/part3-instructions_sp26.pdf)  
- Note: Make sure to check in with your assigned GSI before the due date!
- You can find the rubric for Part 3 of the Data Project on Gradescope (TBD).

## Data Skills Demonstration Project Part III
<iframe src="{{ site.baseurl }}/src/dp/part3-instructions_sp26.pdf" width="100%" height="800"></iframe> 

<hr>

**Due dates:** 

- Group Confirmation Form: **July 19 at 10:00 PM Pacific** (counts towards participation grade)
- Part I is due on **July 26 at 11:59 PM Pacific**
- Part II is due on **August 9 at 11:59 PM Pacific**
- Part III is due on **August 14 at 5:00 PM Pacific**
